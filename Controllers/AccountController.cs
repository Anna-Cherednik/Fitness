...
namespace Fitness.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            // поменять model.Email на model.UserName 
            // либо параметр в функции PasswordSignInAsync 
            var result = await SignInManager.PasswordSignInAsync(model.Email, model.Password, model.RememberMe, shouldLockout: false);
            // Узнаем авторизированного пользователя
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    UserName = model.Email, // логика для model.FIO
                    Email = model.Email,
                    PhoneNumber =
                     model.Telephon
                };
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        Ulica = ulica,
                        ID_ulica = ulica.ID_ulica,
                        Nomer_doma = model.Nomer_doma,
                        Nomer_kvartiru = model.Nomer_kvartiru
                    };
                    FitnesManager.Adresses.Add(adress);

                    var klient = new Klient
                    {
                        FIO_klient = model.FIO,
                        Telephon = model.Telephon,
                        Adress = adress,
                        ID_adress = adress.ID_adress,
                        ID_Login = user.Id
                    };
                    FitnesManager.Klients.Add(klient);
